...
Downloaded from Thorlabs' github 
https://github.com/Thorlabs/Motion_Control_Examples/tree/main/Python/KCube/KPZ101 
To get the dll files, install the thorlabs kinesis software from their webpage
"""
import time
