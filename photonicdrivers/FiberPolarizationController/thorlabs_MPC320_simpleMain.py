...
from photonicdrivers.FiberPolarizationController.Thorlabs_MPC320_driver import Thorlabs_MPC320_Driver
serial_number = "38449564"
polarization_controller = Thorlabs_MPC320_Driver(serial_number)
