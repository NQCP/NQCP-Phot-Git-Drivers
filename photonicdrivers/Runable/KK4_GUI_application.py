...
from GUI.Virtual_Setup import Instrument_Controller
from GUI.Sweep_Wavelength_Menu_Window import Sweep_Wavelength_Menu_Window
from GUI.Sweep_Wavelength_Plot_Window import Sweep_Wavelength_Plot_Window
