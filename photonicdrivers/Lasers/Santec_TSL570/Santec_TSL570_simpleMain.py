...
laser = Santec_TSL570_driver(resource_manager=None, ip_address = "10.209.69.96", port_number = "5000", prints_enabled = False)

laser.connect()
laser.set_wavelength(1521)
wavelength = laser.get_wavelength()
print(wavelength)
print(laser.set_wavelength_unit())
