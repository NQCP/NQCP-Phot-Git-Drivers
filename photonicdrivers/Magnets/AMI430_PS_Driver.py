...
class AMI430_PS_Driver(Connectable):
    ...
    def get_sweep_mode(self) -> str:
        ...
        return state_map.get(state_code, f"Unknown state: {state_code}")
    ...
    def set_ramp_rate_current(self, segment: int, rate: float, upper_bound: float) -> str:
        '''
        ...
        '''
        return self.__query(f"CONFigure:RAMP:RATE:CURRent {segment},{rate},{upper_bound}")
